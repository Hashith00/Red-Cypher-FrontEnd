...
msg.style.top = "0%"; // Center vertically
msg.style.left = "50%"; // Center horizontally
msg.style.transform = "translate(-50%, -50%)"; // Adjust to center the element
...
function play() {
  function move() {
    ...
    if (parseInt(score_val.innerHTML) === 25) {
      msg.style.top = "50%";
      msg.innerHTML = "GAHANNA"; // Center horizontally
    }
    if (parseInt(score_val.innerHTML) === 27) {
      msg.style.top = "50%";
      msg.innerHTML = ""; // Center horizontally
    }
    if (parseInt(score_val.innerHTML) === 40) {
      msg.style.top = "50%";
...
(function (global, factory) {
  ...
  function play() {
    function move() {
      ...
      if (parseInt(score_val.innerHTML) === 10) {
        msg.style.top = "50%";
        msg.innerHTML = "flag1"; // Center horizontally
      }
      if (parseInt(score_val.innerHTML) === 11) {
        msg.style.top = "50%";
        msg.innerHTML = ""; // Center horizontally
      ...
      if (parseInt(score_val.innerHTML) === 20) {
        msg.style.top = "50%";
        msg.innerHTML = "flag2"; // Center horizontally
      }
      ...
      if (parseInt(score_val.innerHTML) === 30) {
        msg.style.top = "50%";
        msg.innerHTML = "flag3"; // Center horizontally
      }
